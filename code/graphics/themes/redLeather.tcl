...
namespace eval ttk::theme::redLeather {
    ...
    ttk::style theme create redLeather -parent clam -settings {
        ...
        ttk::style configure TButton \
            -anchor center -width -8 -padding "1 5 1 5" -relief raised \
            -shiftrelief 2 -highlightthickness 1 -compound center \
        ...
        option add *TCombobox*Listbox.background tomato3
