...
# 03/28/2024 - 0.2.4.1 - Modified colours
#----------------------------------------------------
...
namespace eval ttk::theme::redLeather {
    variable version 0.2.4
    package provide ttk::theme::redLeather $version
    variable colors
    array set colors {
        -disabledfg     gray54
        -frame          black
    ...
    ttk::style theme create redLeather -parent clam -settings {
        ...
        load_images [file join [file dirname [info script]] redLeather]
        ...
        ttk::style configure TButton \
            -anchor center -width -8 -padding "1 2 1 2" -relief raised \
            -shiftrelief 2 -highlightthickness 1 -compound none \
            -highlightcolor $colors(-frame) -focuscolor $colors(-bgcolor)
        ...
        ttk::style configure TCheckbutton \
            ...
            -padding 2 -focuscolor $colors(-bgcolor);
        ...
        ttk::style map TCombobox $colors(-fieldbackground) \
            [list !disabled rosybrown2 \
        ...
        ttk::style configure TCombobox.Listbox -background rosybrown2 \
            -foreground black -selectBackground peachpuff1 \
            -selectForeground $colors(-selectforeground)

        #try {

            #*TCombobox*Listbox.background tomato3
            #*TCombobox*Listbox.foreground black
            #*TCombobox*Listbox.selectBackground peachpuff1
            #*TCombobox*Listbox.selectForeground $colors(-selectforeground)
        #} on error {
        option add *TCombobox*Listbox.background rosybrown2
        option add *TCombobox*Listbox.foreground black
        option add *TCombobox*Listbox.selectBackground peachpuff1
        ...
        # TNotebook
        # --------------------------------------------------
        ttk::style configure TNotebook -background $colors(-bgcolor)
        ...
        ttk::style map TNotebook.Tab \
            ...
            !active $colors(-tvwindowdisabled)] \
            -foreground [list selected white active black !active black] \
            -focuscolor [list selected $colors(-bgcolor)] \
        ...
        ttk::style configure TLabelframe \
            ...
            -labeloutside false -labelmargins {12 0 0 4} \
